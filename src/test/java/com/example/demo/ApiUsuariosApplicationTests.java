...
class ApiUsuariosApplicationTests {
	...
	public void emailJaCadastradoTest() throws Exception {
		...
		assertTrue(content.contains("O e-mail informado já foi cadastrado. Tente outro."));
	}
	...
	public void validacaoDeSenhaForteTest() throws Exception {
		...
		assertTrue(content.contains("Informe a senha com letras minúsculas, maiúsculas, números, símbolos e pelo menos 8 caracteres."));
	}
